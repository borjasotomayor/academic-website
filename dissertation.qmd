---
title: "Dissertation"
description-meta: "Information about Borja Sotomayor's PhD dissertation, 'Provisioning Computational Resources Using Virtual Machines and Leases'"
...
[Updated PDF](files/dissertation/borja_sotomayor_dissertation_updated_20100825.pdf) (08/25/2010), with errata corrected

[Original PDF](files/dissertation/borja_sotomayor_dissertation_original.pdf), as published
 
My dissertation deals, in a nutshell, with how to schedule virtual machines in a distributed system (such as a cluster) to support multiple resource provisioning scenarios (such as the combination of best-effort provisioning and advance reservations) simultaneously and efficiently. For more details, read the [abstract](files/dissertation/abstract.txt) or Chapter 1 ("Introduction") of the dissertation. The introduction provides a high-level overview of the research questions I address in my doctoral work, and should (hopefully) be readable by any technical layperson.
...
If you have any questions on my dissertation, or are interested in addressing some of the future work described in it, please don't hesitate to [contact me](contact.qmd).
...
- [Scripts to reproduce simulated results](files/dissertation/dissertation-exp.tgz)
- [Experimental data](files/dissertation/raw_data_dissertation.tar) [257 MB]
- [Scripts and data to reproduce non-simulated results](files/dissertation/dissertation-exp-nonsim.tgz) [10.3 MB]
...
*Page 100* - Figure 6.2. An older version of the figure was mistakenly used that was missing three data points (for the experiments with "small" nodes, "1h" leases, in configurations "VM-MULT", "VM-REUSE-UNIFORM", and "VM-REUSE-SKEWED"). Compare [original figure](files/dissertation/figure-6.2_original.pdf) with [correct figure](files/dissertation/figure-6.2_fixed.pdf).
